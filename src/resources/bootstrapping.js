...
async function handleNew() {
    const templateRes = await fetch("https://jewels86.me/topaz/main-template.json");
    ...
    const workspaceTemplateRes = await fetch("https://jewels86.me/topaz/workspace-template.json");
    ...
    const profileTemplateRes = await fetch("https://jewels86.me/topaz/profile-template.json");
